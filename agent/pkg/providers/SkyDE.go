...
func Sky_DE(c core.HttpClient) core.Result {
	resp, err := core.GET(c, "https://edge.api.brightcove.com/playback/v1/accounts/1050888051001/videos/6247131490001",
		...
		core.H{"Origin", "https://www.sky.de"},
	)
	if err != nil {
